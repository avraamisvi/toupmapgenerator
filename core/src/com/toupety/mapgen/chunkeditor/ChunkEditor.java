...
import com.toupety.mapgen.LevelGenerator;
...
public class ChunkEditor  extends ApplicationAdapter {
...
//		this.testRenderer = new ShapeRenderer();
		...
		chunk = new Chunk();
		Gdx.input.setInputProcessor(chunk);
	}
...
//		chunk.mousePointer(Gdx.input.getX(), Gdx.input.getY());
